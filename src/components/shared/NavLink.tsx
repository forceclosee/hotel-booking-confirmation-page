						...
						<li class="group">
							...
							<Link
								...
								class={classList(
									...
									props.isDesktop
										? "px-3.5 py-2.5 hover:bg-bg-card hover:text-text hover:ring-1 hover:ring-border-muted hover:ring-inset focus-visible:bg-bg-card focus-visible:text-text data-[status=active]:bg-bg-card"
