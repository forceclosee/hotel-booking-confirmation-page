...
export default function Button(props: Props) {
	...
	return (
		<Btn
			type="button"
			class={cn(
				"min-block-9.5 trim-text flex cursor-pointer items-center rounded-full px-4 font-dm-sans font-medium text-[0.9375rem] transition-all duration-200 active:scale-95",
